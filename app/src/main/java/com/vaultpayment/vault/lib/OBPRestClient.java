...
public class OBPRestClient {
	 ...
	 */
	private static final String OBP_AUTH_KEY = "yd4ou5q4jjw5s1jhlm0p2ofh4oje31zcydpsxzsa";
	private static final String OBP_SECRET_KEY = "wmoqmrea5a3ogefsgpu4vfk4ztyg0pv43lmbnss3";
